...
public class ArticleDao {
	...
	public ArticleDao() {
		...
		Article a1 = new Article(1, "제목1", "내용1", 1, Util.getCurrentDate(), 100, 30);
		Article a2 = new Article(2, "제목2", "내용2", 2, Util.getCurrentDate(), 30, 20);
		Article a3 = new Article(3, "제목3", "내용3", 3, Util.getCurrentDate(), 50, 40);
